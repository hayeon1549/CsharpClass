...
namespace GenericConstraint01
{
    ...
    class Base { }
    class Derived : Base { }
    class BaseArray<U> where U : Base // U는 Base 클래스 이거나 Base의 파생 클래스여야 한다.
    {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //RefArray<int> a = new RefArray<int>(3);
        ...
        public static T CreateInstance<T>() where T : new() //T는 기본생성자가 있어야 한다.
        {
            return new T();
        }
    }
