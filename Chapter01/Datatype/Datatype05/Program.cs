...
namespace StringHandling01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(greeting.EndsWith("Good")); // flase
            Console.WriteLine(greeting.EndsWith("Morning")); //true

            //Contains() : 지정된 문자열을 포함하는지 판단
            Console.WriteLine(greeting.IndexOf("Good")); // true
            Console.WriteLine(greeting.IndexOf("Evening")); //false
